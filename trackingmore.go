...
func main(){
    ...
    //var url string ="http://api.trackingmore.com/v2/trackings/qfkd/RP325552475CN/en"
    //var postData string =""
    //httpDo(url,postData,"GET")
    ...
    //var url string ="http://api.trackingmore.com/v2/trackings/qfkd/RP325552475CN"
    ...
    //var postData string = "{\"tracking_number\": \"RP325552475CN\",\"carrier_code\":\"qfkd\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}"
    //httpDo(url,postData,"POST")

    //10 Modify courier code
    //var url string ="http://api.trackingmore.com/v2/trackings/update"
    //var postData string = "{\"tracking_number\": \"RP325552475CN\",\"carrier_code\":\"qfkd\",\"update_carrier_code\":\"china-ems\"}"
    //httpDo(url,postData,"POST")
    ...
    //var postData string = "[{\"tracking_number\":\"RP325552475CN\",\"carrier_code\":\"qfkd\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]"
    //httpDo(url,postData,"POST")
    ...
    //var postData string = "[{\"carrier_code\":\"qfkd\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]"
    //httpDo(url,postData,"POST")
    ...
    //var postData string = "[{\"tracking_number\":\"RP325552475CN\",\"carrier_code\":\"qfkd\",\"title\": \"4PX page\",\"customer_name\":\"trackingmore user\",\"customer_email\":\"service@trackingmore.com\",\"order_id\":\"#123\",\"logistics_channel\":\"API TEST\",\"destination_code\":\"US\",\"status\":\"7\"},{\"tracking_number1\":\"RP325552475CN\",\"carrier_code\":\"qfkd\",\"title\": \"4PX page\",\"customer_name\":\"trackingmore user\",\"customer_email\":\"service@trackingmore.com\",\"order_id\":\"#123\",\"logistics_channel\":\"API TEST\",\"destination_code\":\"US\",\"status\":\"7\"}]"
    //httpDo(url,postData,"POST")
